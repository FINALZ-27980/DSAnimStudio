...
namespace SoulsAssetPipeline.Animation
{
    ...
    public partial class TAE : SoulsFile<TAE>
    {
        ...
        public bool IsOldDemonsSoulsFormat_0x1000A { get; set; }
        public bool IsOldDemonsSoulsFormat_0x10000 { get; set; }

        public bool HasErrorAndNeedsResave;

        public long? AnimCount2Value { get; set; }
        ...
        protected override void Read(BinaryReaderEx br)
        {
            ...
            BinaryReaderEx binaryReaderEx = br;
        ...
        protected override void Write(BinaryWriterEx bw)
        {
            ...
            for (int i = 0; i < Animations.Count; i++)
            {
                ...
                animation.WriteAnimFile(bw, i, Format);
                Dictionary<float, long> timeOffsets = animation.WriteTimes(bw, i, Format);
                List<long> eventHeaderOffsets = animation.WriteEventHeaders(bw, i, timeOffsets, Format);
                animation.WriteEventData(bw, i, Format);
                animation.WriteEventGroupHeaders(bw, i, Format);
                animation.WriteEventGroupData(bw, i, eventHeaderOffsets, Format);
            }
