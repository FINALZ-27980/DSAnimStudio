...
namespace SoulsAssetPipeline.Animation
{
    public class SplineCompressedAnimation
    {
        ...
        {
            return BitConverter.ToSingle(BitConverter.GetBytes(src), 0);
        }
        ...
        static Quaternion ReadQuatPOLAR32(BinaryReaderEx br)
        {
            ...
            float R = CastToFloat((num >> 18) & (uint)(rMask & 0xFFFFFFFF)) * rFrac;
            R = 1.0f - (R * R);

            float phiTheta = (float)((num & 0x3FFFF));
        ...
        public class SplineTrackQuaternion
        {
            ...
            {
                return GetSinglePoint(FindKnotSpan(Degree, frame, Channel.Values.Count, Knots), Degree, frame, Knots, Channel.Values);
            }
        }
        ...
        public class SplineTrackVector3
        {
            ...
            public float? GetValueX(float frame)
            {
                ...
                return GetSinglePoint(FindKnotSpan(Degree, frame, ChannelX.Values.Count, Knots), Degree, frame, Knots, ChannelX.Values);
            }
            ...
            public float? GetValueY(float frame)
            {
                ...
                return GetSinglePoint(FindKnotSpan(Degree, frame, ChannelY.Values.Count, Knots), Degree, frame, Knots, ChannelY.Values);
            }
            ...
            public float? GetValueZ(float frame)
            {
                ...
                return GetSinglePoint(FindKnotSpan(Degree, frame, ChannelZ.Values.Count, Knots), Degree, frame, Knots, ChannelZ.Values);
            }
        }
